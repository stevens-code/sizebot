...
def sizeray_shrink(data_store: DataStore, interaction: discord.Interaction, target: discord.Member) -> str:
    ...
    return variable_replace(message_format, interaction, data_store, target)
...
def sizeray_malfunction(data_store: DataStore, interaction: discord.Interaction, target: discord.Member) -> str:
...
def sizeray_sizeray(data_store: DataStore, interaction: discord.Interaction, target: discord.Member) -> str:
    ...
    if random_option == 'shrink':
        return sizeray_shrink(data_store, interaction, target)
    elif random_option == 'grow':
        return sizeray_grow(data_store, interaction, target)
    else: # malfunction
        return sizeray_malfunction(data_store, interaction, target)